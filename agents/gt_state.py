...
class GtStateAgent:
    ...
    def __init__(self, name, task, goal_conditioned=False, one_rot_inf=False):
        ...
        # TODO Hacky. I do something similar for `agents/transporter.py`.
        self.real_task = None
    ...
    def extract_x_y_theta(self, object_info, t_worldaug_world=None, preserve_theta=False, softbody=False):
        ...
        """
        # ------------------------------------------------------------------------------------------ #
        # sanity checks to make sure we're handling the soft body ID correctly.
        ...
        if t_worldaug_world is not None:
            ...
            # pretty sure this has to be true. Upper left 3x3 is rotation, upper right 3x1 is position.
            ...
            # data augmentation. Then, extract `object_position` from augmented object.
            t_worldaug_object = t_worldaug_world @ t_world_object
    ...
    def extract_color(self, info):
        # TODO assumption is invalid, I think, if using deformable tasks. So let's change this.
    ...
    def info_to_gt_obs(self, info, t_worldaug_world=None, goal=None):
        """from info dict of IDs, create the observation for GT models.
        ...
        if (self.task in TASKS_SOFT):
            # was getting some errors w/setting the type since usually we will have:
    ...
    def act_to_gt_act(self, act, t_worldaug_world=None, transform_params=None):
        """ similarly, from action, create the appropriate ground truth action.
    ...
    def set_max_obs_vector_length(self, dataset):
        ...
        likely useful for tasks such as palletizing where there's a
    ...
    def get_data_batch(self, dataset):
        ...
        adding goal-conditioning. To make it easier, just stack observations.
        """
        batch_obs = []
        batch_act = []
    ...
    def train(self, dataset, num_iter, writer, validation_dataset=None):
        ...
        not testing with validation, argument copied over from ravens. Naively,
    ...
    def act(self, obs, info, goal=None):
        ...
        # Just go exactly to objects, predicted. adding 1 rotation inference case.
    ...
    def load(self, num_iter):
        ...
        # with the current model. TODO does this work?
    ...
    def _determine_task_stage(self, p0_position, p1_position):
        ...
        # hack to get things in the bounds.
