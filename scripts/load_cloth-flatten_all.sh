...
do
  ...
  --test_step 10 \
  --out_logits 1 \
  --exp_name 1103-07-step4-more_data-set_flat-10 \
  --test_id "$i" \
  --unet 1 \
  --load_critic_dir checkpoints/cloth-flatten-Aff_Critic-12000-1030-09-tryeleven-more-data-2:1-mix1-step-4/critic-ckpt-300000.h5 \
