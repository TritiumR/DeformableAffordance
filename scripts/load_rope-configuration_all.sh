...
do
  ...
  --test_step 10 \
  --out_logits 1 \
  --exp_name 1023-09-S-online-aff-9500-step1-10 \
  --test_id "$i" \
  --load_critic_dir checkpoints/rope-configuration-Aff_Critic-7900-1021-16-tryseven-S-no_perturb-step-1/critic-ckpt-270000.h5 \
