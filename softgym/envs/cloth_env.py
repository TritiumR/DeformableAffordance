...
from softgym.action_space.action_space import  Picker, PickerPickPlace, PickerQPG, PickAndPlace
from softgym.action_space.robot_env import RobotBase
from copy import deepcopy


class ClothEnv(FlexEnv):
    def __init__(self, observation_mode, action_mode, num_picker=2, render_mode='particle', picker_radius=0.025, picker_threshold=0.005, particle_radius=0.00625, **kwargs):
        ...
        assert action_mode in ['picker', 'pickerpickplace', 'sawyer', 'franka', 'picker_qpg', 'pickandplace']
    ...
    def get_default_config(self):
        ...
        config = {
            ...
            'ClothStiff': [1.5, 1.2, 1.5],  # Stretch, Bend and Shear
